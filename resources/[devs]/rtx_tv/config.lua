...
Config.InterfaceColor = "#FFD700" -- change interface color, color must be in hex
...
Config.Targettype = "qb-target" -- types - qtarget, qbtarget, oxtarget

Config.TargetSystemsNames = {qtarget = "qtarget", qbtarget = "qb-target", oxtarget = "ox_target"}

Config.TargetIcons = {tvicon = "fas fa-tv"} 

Config.TvCommand = "dynastytv" -- command for open tv
...
Config.TelevisionControlSettings = {
	...
	permissionsviaidentifiers = { -- permisisontypes - license, steam, xbox, live, discord, ip
		{permissiontype = "license", permisisondata = "license:cee05af2b8cccb4f7c6f7cca07ebe6d94beebac2"}, -- this is example line
		{permissiontype = "license", permisisondata = "license:f4980fb989e35745e2925c1ba5e402a9c06c5e76"}, -- this is example line
		{permissiontype = "license", permisisondata = "license:ac3965c05f3ce0622dbd455c75aca04bfef2bf67"}, -- this is example line
