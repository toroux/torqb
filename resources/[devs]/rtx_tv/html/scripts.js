...
window.addEventListener('message', function (event) {
	...
	if (item.message == "tvshow") {
		...
		if (item.tvurldata == "") {	
			...
			document.getElementById("currently-playing").innerHTML = "<i class='fas fa-play-circle'></i> &ensp;Currently no video is playing";
		} else {
			document.getElementById("currently-playing").innerHTML = "<i class='fas fa-play-circle'></i> &ensp;Currently playing";
