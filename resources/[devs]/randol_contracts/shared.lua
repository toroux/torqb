Config = {
    Ped = {}, -- don't touch
    ProgressCircle = true, -- false will use ox lib rectange progress bar
    Debug = false, -- Mainly used for prints.
    UseTarget = true, -- true will use supported targets qb/ox. false will use ox lib points with a key press [E].
    PhotographItemName = 'photograph', -- item name for the photograph
    Locales = {
        bonus = 'You will receive extra cash for completing the assigned bonus!',
        main_title = 'Contract Negotiator',
        join_q_title = 'Join Queue',
        join_q_desc = 'Get in the queue for assigned hits.',
        leave_q_title = 'Leave Queue',
        leave_q_desc = 'Leave the queue for assigned hits.',
        currjob_title = 'Current Job',
        currjob_desc = ('Name: %s \nOccupation: %s \nLocation: %s \nBonus: %s'),
        give_evid_title = 'Give Evidence',
        give_evid_desc = 'Hand over the photographic evidence.',
        joined_q = 'You have been placed in the queue. Lookout for a message.',
        left_q = 'You have now left the queue.',
        started_already = 'You have started a hit contract already, go finish it.',
        handed_evidence = 'You handed in your evidence and have rejoined the queue.',
        prog_label = 'Snapping a picture..',
        targ_label = 'Take Picture',
        loc_marked = 'Location has been marked on your GPS.',
        ped_talk = 'Talk',
        assigned_hit = 'You have been assigned a hit contract.',
        already_assigned = 'You already have an assigned contract.',
        already_in_q = 'You are already in the queue?',
        not_in_q = 'You aren\'t in the queue dumbass!',
        scaleform_title = 'CONTRACT COMPLETE',
        scaleform_message = 'Target has been killed. Snap a photo and return it to the boss.',
        reward_notify = ('You received $%s for finishing the hit.'),
    },
    debugShit = function(msg)
        print(msg)
    end,
    WeaponList = { -- A weapon list that converts hashes to strings. You can add to these if you know what you are doing but I covered most.
